...
export default function ProPlayersPage() {
    ...
    const dummyPlayers: ProPlayer[] = [
        {
            user_id: 1,
            username: "jason_belmonte",
            name: "Jason Belmonte",
            first_name: "Jason",
            last_name: "Belmonte",
            profile_picture_url: "https://api.dicebear.com/7.x/avataaars/svg?seed=Jason",
            intro_video_url: "",
            xp: 15000,
        ...
        },
        {
            ...
            first_name: "EJ",
            last_name: "Tackett",
            profile_picture_url: "https://api.dicebear.com/7.x/avataaars/svg?seed=EJ",
            intro_video_url: "",
            xp: 18500,
        ...
        {
            user_id: 3,
            username: "shannon_ogrady",
            name: "Shannon O'Grady",
            first_name: "Shannon",
            last_name: "O'Grady",
            profile_picture_url: "https://api.dicebear.com/7.x/avataaars/svg?seed=Shannon",
            intro_video_url: "",
            xp: 12800,
    ...
    useEffect(() => {
        const fetchProPlayers = async () => {
            try {
                ...
                setProPlayers(dummyPlayers);

                // Initialize following states based on dummy data
                const followStates: { [key: number]: boolean } = {};
                dummyPlayers.forEach((player: ProPlayer) => {
